...
function Button({ children, disabled, to, type, onClick }) {
  // //Átalakítottuk a css stílust base-re és azt kiegészítendíő stylokra (type paraméterbe kapja meg pontosan milyen paddingja legyen a buttonnak.)
  // const className =
  ...
  //Ha átadunk a <Button>-nal onclik propt ezzel tér vissza
  if (onClick) {
    return (
